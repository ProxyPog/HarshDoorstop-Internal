		...
		switch (tabIndex) {
			case Config::TAB_VISUALS: {
				...
				{ // Players Box 3D
					...
					//name
					ImGui::Checkbox("Players Name", &Config::entname);
				}
			...
			case Config::TAB_AIM: {

				{
					...
					ImGui::Checkbox("Enable Aimbot->binded to RightMouse", &Config::m_bEnableAimbot);
			...
			case Config::TAB_EXPLOITS: {
				...
				{
				//Config::bullettp
				//ImGui::Checkbox("Bullet TP", &Config::bullettp);
				}

				//m_bPlayerChams
				//ImGui::Checkbox("Chams", &Config::m_bPlayerChams);
				...
				{ // Fly
					ImGui::Checkbox("Fly->Binded to C", &Config::m_bFly);
				}
				//setactoreyes
				{ 
					ImGui::Checkbox("Test Actor Eye With 0,90,0", &Config::setactoreyes);
				}
				...
				{ //teleport
					ImGui::Checkbox("Enable teleport", &Config::tp);
					ImGui::Text("Warp Point");

					ImGui::SameLine();
					ImGui::InputFloat3("##WarpCoords", (float*)&Config::NewLocation);
